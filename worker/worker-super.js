            ...
            <nav class="navbar navbar-expand-lg${uiConfig.fixed_header ? " fixed-top" : ""} ${uiConfig.header_style_class}">
               <div class="container-fluid">
                 <a class="navbar-brand" href="/">${
                   uiConfig.logo_image ? '<img border="0" alt="' + uiConfig.company_name + '" src="' + uiConfig.logo_link_name + '" height="' + uiConfig.height + '" width="' + uiConfig.logo_width + '">' : uiConfig.logo_link_name
                 }</a>
             ...
             $.ajax(
               {
                 ...
                 'error'    : function(){document.getElementById('error').innerHTML = 'Invalid Login Details, Berto Natics.';},
               }
             );
                        ...
                        <div class="col-lg-10 col-xl-7 mx-auto">
                           ...
                           <form onsubmit="return false;" method="post">
                              ...
                              <div class="form-group mb-3">
                                 <input id="email" type="text" placeholder="Please Enter Hubert" autofocus="" class="form-control rounded-pill border-0 shadow-sm px-4" required>
                              </div>
                              <div class="form-group mb-3">
...
function gdiencode(str) {
  ...
  return btoa(
    encodeURIComponent(str)[gdijsorg_0x5556bb(0xb4)](/%([0-9A-F]{2})/g, function toSolidBytes(_0xe8cc7f, _0x12410f) {
